...
def test_openstates_full_flow_with_parameter_store():
    ...
    with patch("boto3.client") as mock_boto_client:
        mock_ssm = Mock()
        mock_ssm.get_parameter.return_value = {"Parameter": {"Value": "test-openstates-key-789"}}
...
def test_openstates_real_api_call():
    ...
    representatives = client.get_representatives_by_division("ocd-division/country:us/state:ca")
...
def test_multiple_divisions_workflow():
    ...
    def mock_get_side_effect(*args, **kwargs):
        ...
        mock_response.json.return_value = responses.get(
            jurisdiction, {"results": [], "pagination": {"total_items": 0}}
        )
